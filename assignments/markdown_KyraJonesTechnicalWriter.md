...
1. Now more than ever, Markdown proves to be exceptional for a huge reason: AI.
    ...
    AI seems to be a never-ending topic, but there is a good reason for it.
...
3. Modern-day version control is a writer's dream come true.
    ...
    In fact, it makes things more cohesive to use the same tool as your peers.

    Plus, these often have built-in editors and even "flavored" Markdown types.
...
4. Different "flavors" of Markdown allow for extended syntax.
    ...
    For example, GitHub has a GitHub-flavored Markdown.

    This version allows strikethroughs which Markdown doesn't support natively.
...
1. There are limits to the standard Markdown language.
    ...
    That which is why it forgoes fancy colors and fonts.
...
Ultimately, the choice of how you write your documents is entirely up to you.

Since there are lots of aspects to consider, there's no correct answer.

You know your situation best and can decide if Markdown is a good fit.
